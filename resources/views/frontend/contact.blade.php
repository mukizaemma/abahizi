    ...
    <section class="contact-page-shell pt-40 pb-50 grey-bg">
        <div class="container">
            ...
            <div class="contact-form-zone">
                ...
                <div class="contact-form-zone__inner">
                    <div class="contact-form-card site-form-card">
                        ...
                        <div class="contact-form-card__body">
                            ...
                            @else
                                <form action="{{ route('sendMessage') }}" method="POST" class="row g-3 g-lg-4 site-channel-form site-partner-form" data-form-type="contact" novalidate>
                                    @csrf
            ...
            <div class="contact-map-zone">
                ...
                <div class="contact-map-zone__inner">
                    <div class="contact-map-wrap contact-map-wrap--stacked">
                        @if($mapIframeHtml !== '')
