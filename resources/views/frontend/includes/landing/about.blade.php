...
<section class="lh-about" id="lh-about" aria-labelledby="lh-about-title">
    <div class="container">
        <div class="lh-about__grid">
            <div class="lh-reveal">
                <p class="lh-eyebrow">{{ \App\Support\SiteCopy::get('about_eyebrow') }}</p>
                <h2 id="lh-about-title" class="lh-about__title">{{ \App\Support\SiteCopy::get('about_title') }}</h2>
                <p class="lh-about__text lh-body">{{ $aboutBody }}</p>
                <a href="{{ route('backgroundDetails') }}" class="lh-btn lh-btn--soft">{{ \App\Support\SiteCopy::get('about_cta') }}</a>
            </div>
            <div class="lh-reveal">
