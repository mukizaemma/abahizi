...
<html lang="en" data-turbo="false">
    <head>
        @php
            $themeSetting = (($setting ?? null) instanceof \App\Models\Setting)
                ? $setting
                : \App\Models\Setting::firstOrEmpty();
            $theme = \App\Support\ThemeService::fromSetting($themeSetting);
        @endphp
        <meta charset="utf-8" />
        ...
        <link href="{{ asset('assets/admin/css/admin-refine.css') }}?v=20260917u" rel="stylesheet" />
    ...
    <body class="sb-nav-fixed">
        ...
        <script src="{{ asset('assets/admin/js/admin-media.js') }}?v=20260917u"></script>
        <script>
